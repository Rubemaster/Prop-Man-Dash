			...
			<div className="col" style={{ minWidth: "200px" }}>
				<div className="col-md">
					<Link to="/properties" style={{ color: "inherit", textDecoration: "none" }}>
						<div className="card text-center text-white mb-3" id="total-orders" style={{ minHeight: "200px" }}>
			...
			<div className="col" style={{ minWidth: "200px" }}>
				<div className="col-md">
					<Link to="/inspections-pending" style={{ color: "inherit", textDecoration: "none" }}>
						<div className="card text-center text-white mb-3" id="orders-delivered" style={{ minHeight: "200px" }}>
			...
			<div className="col" style={{ minWidth: "200px" }}>
				<div className="col-md">
					<Link to="/results" style={{ color: "inherit", textDecoration: "none" }}>
						<div className="card text-center text-white mb-3" id="orders-pending" style={{ minHeight: "200px" }}>
