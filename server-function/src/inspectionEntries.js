...
// Same Zite Database + table as propertyEntries.js -- both properties and
// inspections land as rows in this one table. A row is an inspection
// (rather than a property) when its `propertyid` field is set, since an
// inspection references the property it's for.
//
...
export async function handleInspectionEntries(request, env) {
